 ...
 */
public class ProcessManipulator implements Runnable{
	...
	/**
	 * This method monitors whether a 
	 * @param icons
	 * @param taskLabels
	 * @param labels
	 * @throws IOException
	 */
	public ProcessManipulator(ArrayList<Icon> icons, JLabel[] taskLabels, JLabel[][] labels){
		this.icons = icons;
